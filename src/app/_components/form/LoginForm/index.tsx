    ...
    return (
        <div className="w-[100%] h-[100%] max-w-[700px] mx-auto flex justify-center items-center">
            <form action="" className="flex flex-col bg-[#c4d8e7] gap-6 items-center py-10 px-5 w-[100%] max-w-md rounded-md shadow-lg">
                ...
                <button className="bg-[#29b6f6] text-white text-base font-medium rounded w-[100%] p-3 hover:bg-[#00aeff]">Login</button>
                <Link className="bg-[#868E96] text-white text-base font-medium rounded w-[100%] p-3 hover:bg-[#6C737B] flex justify-center" href="/register">Register</Link>
            </form>
        </div>
    )
}